...
public class HistoryVO {
	...
	public HistoryVO(String user_id, String res_code, String user_code, String hos_code, String pet_code,
			String user_name, String user_tel, String useR_id2, String hos_name, String hos_sub, Date receipt_date,
			Date res_date, String res_time, String pet_name, String pet_sex, int pet_age, String b_type,
			float pet_weight, String pet_types, String pet_number, String res_etc, Date r_res_date, Date r_receipt_date,
			String r_hos_name, String r_res_code, String r_hos_code, String tx_code, String tx_res_code,
			Date tx_reserv_day, String tx_dep, String tx_arr, String tx_number, String tx_name, String tx_local,
			String tx_tel, String ttx_code, String ttx_res_code, Date ttx_reserv_day, String ttx_dep, String ttx_arr,
			String ttx_number, String ttx_name, String ttx_tel, String tx_img, String hos_thum) {
		super();
